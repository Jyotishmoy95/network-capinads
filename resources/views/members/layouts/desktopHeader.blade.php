    ...
    <div class="container-fluid">
        ...
        <div class="main-header-center">
            <div class="responsive-logo">
                <a href="{{ asset('member/dashboard') }}"><img src="{{ asset('logo.png') }}" style="width:150px;" class="mobile-logo" alt="logo"></a>
                <a href="{{ asset('member/dashboard') }}"><img src="{{ asset('logo.png') }}" class="mobile-logo-dark" alt="logo"></a>
            </div>
        </div>
        <div class="main-header-right">
            ...
            <div class="dropdown main-profile-menu">
                <a class="d-flex" href="#">
                    <span class="main-img-user" ><img alt="avatar" src="{{ asset('uploads/profile-pictures/'.auth()->user()->photo) }}"></span>
                </a>
                <div class="dropdown-menu">
                    <div class="header-navheading">
                        <h6 class="main-notification-title">{{ auth()->user()->full_name }}</h6>
                        <p class="main-notification-text">{{ auth()->user()->member_id }}</p>
                    </div>
                    <a class="dropdown-item border-top" href="{{ asset('member/settings/index') }}">
