...
@section('title', 'Direct Referrals')
...
@section('content')
    ...
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">Direct Referrals</h2>
            <ol class="breadcrumb">
    ...
    <div class="row row-sm">
        ...
        <div class="card custom-card">
                <div class="card-body">
                    <div>
                        <h6 class="main-content-label mb-1">Direct Referrals</h6>
                    </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#dataTable").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('member.network.referrals') }}",
                    type: 'post',
                    data: function (data) {
