    ...
    <div class="page-header">
        ...
        <div class="d-flex">
            <div class="justify-content-center">
                <a href="{{ asset('/admin/downloads/create') }}" class="btn btn-primary my-2 btn-icon-text">
                    <i class="fe fe-plus-circle mr-2"></i> Create New Download
                </a>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $(document).on('click', '.delete-file', function(e){
                ...
                Swal.fire({
                    text: 'Do you want to delete selected download?',
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url:"{{ route('admin.downloads.destroy') }}",
                            method:'post',
            ...
            $("#dataTable").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.downloads.list') }}",
                    type: 'post',
                    data: function (data) {
