...
@section('title', 'Non Working Members')
...
@section('content')
    ...
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">Non Working Members</h2>
            <ol class="breadcrumb">
    ...
    <div class="row row-sm">
        <div class="col-12">
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        <h6 class="main-content-label mb-1">Non Working Members</h6>
                    </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#dataTable").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.members.nonWorking') }}",
                    type: 'post',
                    data: function (data) {
